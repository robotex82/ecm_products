...
feature 'Ecm::Products::Product admin' do
  ...
  def set_resource_path
    @resource_path = "ecm_products_products"
  end

  def set_resource_class
    @resource_class = Ecm::Products::Product
  end
  ...
  def fill_new_form
    select @product_category.name,        :from => 'ecm_products_product[ecm_products_product_category_id]'  
    fill_in "ecm_products_product[name]", :with => "Example product"
    select 'textile',                     :from => 'ecm_products_product[markup_language]'  
  end

  def fill_edit_form
    fill_in "ecm_products_product[name]", :with => "An updated product"
  end
