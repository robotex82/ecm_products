...
feature 'Ecm::Products::ProductLink admin' do
  ...
  def set_resource_path
    @resource_path = "ecm_products_product_links"
  end

  def set_resource_class
    @resource_class = Ecm::Products::ProductLink
  end
  ...
  def fill_new_form
    select @product.name, :from => 'ecm_products_product_link[ecm_products_product_id]'
    fill_in "ecm_products_product_link[name]", :with => "Example product link"
    fill_in "ecm_products_product_link[url]", :with => "http://www.example.com"
    select 'textile', :from => 'ecm_products_product_link[markup_language]'
  end

  def fill_edit_form
    fill_in "ecm_products_product_link[name]", :with => "An updated product link"
  end
