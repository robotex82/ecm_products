...
feature 'Ecm::Products::ProductCategory admin' do
  ...
  def set_resource_path
    @resource_path = "ecm_products_product_categories"
  end

  def set_resource_class
    @resource_class = Ecm::Products::ProductCategory
  end
  ...
  def fill_new_form
    select I18n.locale.to_s,                       :from => 'ecm_products_product_category[locale]'  
    fill_in "ecm_products_product_category[name]", :with => "Example product category"
    select 'textile',                              :from => 'ecm_products_product_category[markup_language]'  
  end

  def fill_edit_form
    fill_in "ecm_products_product_category[name]", :with => "An updated product category"
  end
